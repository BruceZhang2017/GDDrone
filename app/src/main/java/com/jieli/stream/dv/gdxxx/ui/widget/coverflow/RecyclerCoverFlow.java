...
public class RecyclerCoverFlow extends RecyclerView {
    ...
    public void setSelectPositionByScroll(int position) {
        RecyclerView.State state=new RecyclerView.State();
        getCoverFlowLayout().smoothScrollToPosition(this,state,position);
    }
    public void setSelectPosition(int position) {
        getCoverFlowLayout().scrollToPosition(position);
    }
}
