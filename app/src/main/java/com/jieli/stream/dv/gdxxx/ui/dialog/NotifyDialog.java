...
public class NotifyDialog extends BaseDialogFragment {
    ...
    private ProgressBar mProgressBar, mHorizontalProgressBar;
    ...
    public void setProgress(int progress) {
        if (mHorizontalProgressBar != null && mHorizontalProgressBar.getVisibility()==View.VISIBLE) {
...
//        Dbug.d(tag, "onCreateView:..........");
        ...
        mHorizontalProgressBar = (ProgressBar) view.findViewById(R.id.progressBar_horizon);
